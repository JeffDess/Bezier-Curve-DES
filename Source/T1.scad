...
down(0)keycap(keyID=0, Dish=true, Stem=true, crossSection=false, visualizeDish=false);  //gen
...
//  BotWid, BotLen, TWDif, TLDif, keyh, WSft, LSft  XSkew, YSkew, ZSkew, WEx, LEx, CapR0i, CapR0f, CapR1i, CapR1f, CapREx, StemEx, jog1, jog2 
   [17.16, 17.16, 4, 5, 8.25,  -.25,  .5,  1,  -8,   0,   2,   2,      1,      4,      1,      4,     2,       2, 0, 0], //In
];
...
function elliptical_rectangle(a = [1,1], b =[1,1], fn=32, jog1 = 0, jog2 = 0) = [
