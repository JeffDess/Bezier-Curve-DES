...
right(0)down(0)keycap(keyID=0, Dish=true, Stem=true, crossSection=false, visualizeDish=false, Sym=false); 
...
//center duplicates
  //Left
CenterLeftBezNodes0   = [[ 0,-2.], [6.3,-.5], [8.3,-1.3]];
CenterLeftBezControl0 = let(a1=190, a2=130, a3=100)[["null"], [0, 0], [ 3.5,   0], 
                          [.5, a1], [0, 0], [.5, a1+180],
                          [1,  a2], [0, 0], ["null"]];  
//Right
CenterRightBezNodes0   = [[ 0,-2.], [7.3,-.5], [9.7,-1.3]];
...
ForwardLeftBezNodes2   = [[ 0, -.75], [ 5.3,-1.25], [7.4,-2.2]];
ForwardLeftBezControl2 = let(a1=170, a2=145)[["null"], [0, 0], [ 1,   0], 
                          [ 1.,a1], [0, 0], [1., a1+180],
                          [ 1., a2], [0, 0], [ "null"]];
                          
ForwardRightBezNodes2   = [[ 0, -.75], [ 4.6,-1.], [7.2,-1.9]];
...
BackLeftBezNodes2   = [[ 0,-1.5], [7.0,-.5], [10.0,-1.3]];
BackLeftBezControl2 = let(a1=190, a2=130, a3=100)[["null"], [0, 0], [ 3.5,   0], 
                          [.5, a1], [0, 0], [.5, a1+180],
                          [1,  a2], [0, 0], ["null"]];
                          
BackRightBezNodes2   = [[ 0,-1.5], [10.5,-.5], [12.,-1.3]];
